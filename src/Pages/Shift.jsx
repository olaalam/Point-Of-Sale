...
export default function Shift() {
 ...
 {/* "Take your shift" button when shift is closed */}
 ...
 {/* "Back to Work" button when shift is open */}
 {isShiftOpen && (
  <motion.div
 key="back-to-work"
 className="px-6 pb-6"
 ...
 <motion.button
  onClick={() => navigate("/")}
  className="w-full bg-gray-600 hover:bg-gray-700 text-white font-medium py-4 px-6 rounded-lg transition-all duration-300 flex items-center justify-center gap-3 group"
  whileHover={{ scale: 1.02 }}
  whileTap={{ scale: 0.98 }}
 >
